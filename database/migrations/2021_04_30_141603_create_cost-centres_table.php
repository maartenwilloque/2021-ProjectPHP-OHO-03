...
class CreateCostCentresTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cost-centres', function (Blueprint $table) {
            $table->id();
            $table->foreignId('responsible');// shorthand for $table->unsignedBigInteger('id');
            $table->string('cost-centre',13)->unique();
    ...
    {
        Schema::dropIfExists('cost-centres');
    }
}
