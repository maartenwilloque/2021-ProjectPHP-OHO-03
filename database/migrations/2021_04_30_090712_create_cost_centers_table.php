...
class CreateCostCentersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cost_centers', function (Blueprint $table) {
            ...
            $table->string('cost_center',13)->unique();
