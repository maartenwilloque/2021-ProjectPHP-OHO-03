...
')
     ...
     */ 
        ...
        {
                        return \App\Helpers\Json::dump($data, $onlyInDebugMode);
        }
     ...
     */ 
        ...
        {
                        /** @var \App\Helpers\MyExpense $instance */
         ...
         * @static 
         */ 
        public static function getOneExpense($key)
        {
                        /** @var \App\Helpers\MyExpense $instance */
                        return $instance->getOneExpense($key);
        }
                    /**
         * 
         *
...
namespace  { 
            ...
            class MyExpense extends \Facades\App\Helpers\MyExpense {}
