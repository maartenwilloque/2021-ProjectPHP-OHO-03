...
@section('main')
    <h1>Update user: {{ $user->name." ".$user->firstname }}</h1>
    <form action="/admin/user/{{ $user->id }}" method="post">
        ...
        <fieldset>
            <div class="form-check">
                @if($user->active ==1)
                    <input class="form-check-input" type="checkbox" name="active[]" value="" id="activeTrue" checked>
            ...
            <div class="form-check">
                ...
                @else
                    <input class="form-check-input" type="checkbox" name="approver[]" value="" id="approverFalse">
            ...
            <div class="form-check">
                @if($user->finance ==1)
                    <input class="form-check-input" type="checkbox" name="finance[]" value="" id="financeTrue" checked>
            ...
            <div class="form-check">
                @if($user->admin ==1)
                    <input class="form-check-input" type="checkbox" name="admin[]" value="" id="adminTrue" checked>
